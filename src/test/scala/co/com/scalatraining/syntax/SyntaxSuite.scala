...
class SyntaxSuite extends FunSuite{
  ...
  test("Un trait puede tener tambien implementaciones en objetos"){
    trait MyTrait {
      def f1(a:Int) = a + 1
    }
  ...
  test("Un trait puede tener tambien implementaciones con mismo nombre de metodo"){
    trait MyTrait {
      def f1(a:Int) = a + 1
    }
